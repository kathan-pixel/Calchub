...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget build(BuildContext context) {
    List<Calculator> filtered = _selectedCategory == -1
        ? calculators
        : calculators.where((c) => c.category.index == _selectedCategory).toList();
...
class CalculatorDetailScreen extends StatelessWidget {
  ...
  const CalculatorDetailScreen({Key? key, required this.calculator})
      : super(key: key);
